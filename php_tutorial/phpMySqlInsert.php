<?php $page='41'; include '../header.php'; ?>
...
(adsbygoogle = window.adsbygoogle || []).push({});
		...
		<div >
			<h1>PHP MySQL Insert</h1>
 				 <a href="phpMySqlCreateTable.php" class="w3-btn w3-border">PREVIOUS</a>
				 <a href="phpMySqlUpdate.php" class="w3-btn w3-teal" style="float: right;">NEXT</a>
            
           <p>PHP mysql_query() function is used to insert record in a table.</p>
            <h2>Insert Record</h2>
            ...
            &nbsp;$sql = 'INSERT INTO emp4(name,salary) VALUES ("Mac", 10000)';<br>  
...
(adsbygoogle = window.adsbygoogle || []).push({});
            ...
            <p>Connected successfully<br>Record inserted successfully</p>
